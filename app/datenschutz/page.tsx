export const metadata = {
  title: 'Datenschutz — AI Advisory',
}

export default function Datenschutz() {
  return (
    <div className="px-6 lg:px-20 py-24 lg:py-[120px] max-w-[720px]">
      <h1 className="text-white text-4xl font-extrabold tracking-tight mb-10">Datenschutzerklärung</h1>

      <section className="mb-8">
        <h2 className="text-white text-lg font-bold mb-3">1. Verantwortliche Stelle</h2>
      ...
      <section className="mb-8">
        <h2 className="text-white text-lg font-bold mb-3">2. Erhebung und Verarbeitung personenbezogener Daten</h2>
        <p className="text-body text-base leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-white text-lg font-bold mb-3">3. Zweck der Datenverarbeitung</h2>
        <p className="text-body text-base leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-white text-lg font-bold mb-3">4. Speicherdauer</h2>
        <p className="text-body text-base leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-white text-lg font-bold mb-3">5. Ihre Rechte</h2>
        <p className="text-body text-base leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-white text-lg font-bold mb-3">6. Cookies und Analyse-Tools</h2>
        <p className="text-body text-base leading-relaxed">
      ...
      <section>
        <h2 className="text-white text-lg font-bold mb-3">7. Änderungen dieser Datenschutzerklärung</h2>
        <p className="text-body text-base leading-relaxed">
